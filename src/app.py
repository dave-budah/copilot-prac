...
activities = {
    ...
    "Art Club": {
        "description": "Drawing, painting, and mixed-media projects with guest workshops",
    ...
    "Debate Team": {
        "description": "Prepare for debate competitions, public speaking, and research",
        "schedule": "Mondays, Wednesdays, 3:30 PM - 4:45 PM",
        "max_participants": 14,
        "participants": ["lily@mergington.edu", "grace@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Team-based science and engineering challenges and competitions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
...
@app.get("/activities")
def get_activities():
    # Return activities and instruct clients/proxies not to cache the response
